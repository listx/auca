...
\author{Linus Arver\\
\\
{\small ver. AUCA_VERSION_TEXT\fn{This is the latest git commit hash of the master branch from \url{www.github.com/listx/auca}; the aforementioned version was used to generate this document.}}
}
\date{\today}
\maketitle
\tableofcontents
